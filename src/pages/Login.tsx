          ...
          <div className="grid md:grid-cols-3 gap-6">
            {roleCards.map(({ role, title, Icon, description }) => (
              <button
                ...
                className="bg-white p-6 rounded-lg text-left hover:bg-primary-50 transition-colors border-2 border-primary-100 hover:border-primary-500 focus:outline-none focus:border-primary-500 shadow-soft"
              >
    ...
    <div className="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white p-8 rounded-lg shadow-soft">
          {selectedCard && (
            <>
              <selectedCard.Icon className="h-12 w-12 text-primary-500 mb-4" />
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {success && (
              <div className="flex items-center p-4 text-green-600 bg-green-50 rounded-md">
                <span>{success}</span>
              </div>
            )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-dark-700 border border-dark-600 rounded-md text-white placeholder-dark-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
