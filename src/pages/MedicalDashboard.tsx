      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {patient && (
          <div className="bg-white p-6 rounded-lg shadow-soft">
            <h3 className="text-xl font-semibold text-secondary-900 mb-4">Patient Information</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-secondary-100 p-4 rounded-lg">
                <span className="block text-secondary-700 text-sm">Name</span>
                <span className="text-secondary-900">{patient.name}</span>
              </div>
              <div className="bg-secondary-100 p-4 rounded-lg">
                <span className="block text-secondary-700 text-sm">Age</span>
                <span className="text-secondary-900">{patient.age} years</span>
              </div>
              <div className="bg-secondary-100 p-4 rounded-lg">
                <span className="block text-secondary-700 text-sm">Gender</span>
                <span className="text-secondary-900">{patient.gender}</span>
              </div>
              <div className="bg-secondary-100 p-4 rounded-lg">
                <span className="block text-secondary-700 text-sm">UHID</span>
                <span className="text-secondary-900">{patient.uhid}</span>
              </div>
            </div>
