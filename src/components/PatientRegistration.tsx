      ...
      <div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
        <div className="text-center space-y-4">
          ...
          <button
            ...
            className="w-full bg-primary-600 text-white px-6 py-3 rounded-lg hover:bg-primary-700 transition-colors mt-4"
          >
    ...
    <div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <select
            required
            className="w-full px-4 py-2 bg-white border border-secondary-200 rounded-lg text-secondary-900"
        ...
        <div>
          <label className="block text-secondary-700 mb-2">Aadhaar Number</label>
          <input
            type="text"
            required
            pattern="\d{12}"
